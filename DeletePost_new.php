...
<div class="container-fluid">
  ...
  <div class="card-body">
    <span class="glyphicon glyphicon-equalizer display-5 text-center mr-2"></span> Logout
     ...
     echo SuccessMessage();?></div>
      <h1 class="mt-4" style="font-family: 'Acme', sans-serif; color:#343a40; ">Delete Post</h1><hr class="mb-4">
 ...
 <div class="mt-5 mb-5">
      ...
      ?>
     <form action="DeletePost_new.php?Delete=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data">
      <fieldset>
    ...
    ?>
       ...
       <textarea disabled class="form-control" name="Post" id="postarea">
        ...
        <input class="btn btn-danger btn-sm mt-3" style="width: 100%;" type="Submit" name="Submit" value="Delete Post">
      </fieldset>
     </form>
    </div>
